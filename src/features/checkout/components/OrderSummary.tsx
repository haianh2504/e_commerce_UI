  ...
  return (
    <Card className="lg:sticky lg:top-28">
      ...
      <ul className="mt-6 divide-y divide-border">
        {items.map((item) => <li key={item.id} className="grid grid-cols-[4.5rem_minmax(0,1fr)] gap-4 py-4 first:pt-0 sm:grid-cols-[4.5rem_minmax(0,1fr)_auto]">
          ...
          <p className="col-start-2 text-sm font-semibold sm:col-auto">{formatVnd(calculateLineTotal(item))}</p>
        </li>)}
      </ul>
