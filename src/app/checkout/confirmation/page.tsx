...
export const metadata: Metadata = { title: "Xác nhận minh họa" };
export default function CheckoutConfirmationPage() {
  return <><StoreHeader /><main className="min-h-[75svh] pt-18 lg:pt-20"><Container size="content" className="py-12 sm:py-16 lg:py-24"><Card className="text-center">
